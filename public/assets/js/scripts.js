    ...
    (NioApp.Navbar = {
                ...
                a.forEach((e) => {
                    let a = {
                            format: e.dataset.format
                                ? parseInt(e.dataset.format)
                                : 12,
                            interval: e.dataset.interval
                                ? parseInt(e.dataset.interval)
                                : 30,
                            start: e.dataset.startTime
                                ? e.dataset.startTime
                                : "12:00",
                            end: e.dataset.endTime
                                ? e.dataset.endTime
                                : "23:00",
                        },
        ...
        (NioApp.DatePicker = function (e, t) {
            ...
            a.length > 0 &&
                a.forEach((e) => {
                    let a =
                            !e.dataset.autoHide ||
                            JSON.parse(e.dataset.autoHide),
                        s =
                            !!e.dataset.clearBtn &&
                            JSON.parse(e.dataset.clearBtn),
                        o = e.dataset.format ? e.dataset.format : "mm/dd/yyyy",
                        i = e.dataset.maxView ? parseInt(e.dataset.maxView) : 3,
                        n = e.dataset.pickLevel
                            ? parseInt(e.dataset.pickLevel)
                            : 0,
                        l = e.dataset.startView
                            ? parseInt(e.dataset.startView)
                            : 0,
                        r = e.dataset.title ? e.dataset.title : "",
                        c =
                            !!e.dataset.todayBtn &&
                            JSON.parse(e.dataset.todayBtn),
                        p = e.dataset.todayBtnMode
                            ? parseInt(e.dataset.todayBtnMode)
                            : 0,
                        d = e.dataset.weekStart
                            ? parseInt(e.dataset.weekStart)
                            : 0,
                        u = !!e.dataset.range,
                        m = t || {
        ...
        (NioApp.Pureknob = function (e) {
            document.querySelectorAll(e).forEach((e) => {
                let t = e.dataset.size ? parseInt(e.dataset.size) : 100,
                    ...
                    i = e.dataset.colorBg
                        ? e.dataset.colorBg
                        : NioApp.Colors.gray200,
                    n = e.dataset.colorFg
                        ? e.dataset.colorFg
                        : NioApp.Colors.primary,
        ...
        (NioApp.Dropzone = function (e) {
            ...
            "undefined" != t &&
                ...
                t.forEach((e) => {
                    let t = e.id,
                        a = e.dataset.maxFiles
                            ? parseInt(e.dataset.maxFiles)
                            : null,
                        s = e.dataset.maxFilesize
                            ? parseInt(e.dataset.maxFilesize)
                            : 256,
                        o = e.dataset.messageIcon
                            ...
                            ? "file"
                            : "files",
                        i = e.dataset.acceptedFiles
                            ? e.dataset.acceptedFiles
                            : null;
            ...
            "undefined" != a &&
                ...
                a.forEach((e) => {
                    ...
                    let o = e.dataset.min ? parseInt(e.dataset.min) : 0,
                        ...
                        n = e.dataset.minDistance
                            ? parseInt(e.dataset.minDistance)
                            : null,
                        l = e.dataset.maxDistance
                            ? parseInt(e.dataset.maxDistance)
                            : null,
                        r = e.dataset.step ? parseInt(e.dataset.step) : 1,
                        c = e.dataset.orientation
                            ? e.dataset.orientation
                            : "horizontal",
                        p =
                            !!e.dataset.tooltip &&
                            JSON.parse(e.dataset.tooltip);
                    console.log(a, s);
                    var d = {
                            start: a,
                            connect: s,
